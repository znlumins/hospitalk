...
export default function AdminPage() {
  const auditLogs = [
    { id: '1', user: 'Dr. Demo', action: 'UPDATE_TRANSCRIPT', resource: 'Session #1234', time: '2026-06-10 10:15:22', ip: '192.168.1.5' },
    { id: '2', user: 'Suster Rina', action: 'CREATE_SESSION', resource: 'Patient RM-001', time: '2026-06-10 09:55:10', ip: '192.168.1.10' },
    { id: '3', user: 'Admin IT', action: 'USER_LOGIN', resource: 'System', time: '2026-06-10 08:00:05', ip: '10.0.0.5' },
    { id: '4', user: 'Dr. Demo', action: 'VIEW_PATIENT', resource: 'Patient RM-002', time: '2026-06-09 14:20:00', ip: '192.168.1.5' },
  ];
